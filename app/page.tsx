...
export default function Home() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8">
                We build custom web applications, mobile solutions, and business intelligence tools 
                that help growing businesses scale and succeed.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#contact" className="btn-primary px-8 py-3 rounded-full font-medium text-center">
                  Get in Touch
                </a>
                <a href="#services" className="btn-secondary px-8 py-3 rounded-full font-medium text-center">
                  Our Services
                </a>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="card p-6">
              ...
              <p className="text-gray-300 mb-4">
                We develop scalable, user-focused web applications using modern frameworks like React, Angular, and Vue.js.
              </p>
            ...
            <div className="card p-6">
              ...
              <p className="text-gray-300 mb-4">
                We create native and cross-platform mobile solutions for iOS and Android using React Native and Flutter.
              </p>
              <ul className="text-gray-300 space-y-2 mb-6">
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#00E2D6] mr-2 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="card p-6">
              ...
              <p className="text-gray-300 mb-4">
                We build data analytics dashboards, reporting tools, and predictive modeling solutions.
              </p>
              <ul className="text-gray-300 space-y-2 mb-6">
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#00E2D6] mr-2 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#2d3741] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <h2 className="section-heading text-3xl sm:text-4xl font-bold">Get In Touch</h2>
          <p className="text-gray-300 text-lg max-w-3xl mx-auto mt-4 text-center">
            Ready to transform your business with innovative technology solutions? Our team is here to help you succeed.
          </p>
          ...
          <div className="bg-[#232B32] rounded-2xl shadow-xl overflow-hidden mt-16">
            <div className="grid grid-cols-1 lg:grid-cols-5">
              ...
              <div className="lg:col-span-2 bg-gradient-to-br from-[#232B32] to-[#2d3741] p-8 lg:p-12">
                ...
                <div className="mt-12">
                  ...
                  <div className="flex space-x-4">
                    <a href="https://twitter.com/tecsudo" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-[#00E2D6]/10 flex items-center justify-center text-[#00E2D6] hover:bg-[#00E2D6]/20 transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M22.162 5.656a8.384 8.384 0 0 1-2.402.658A4.196 4.196 0 0 0 21.6 4c-.82.488-1.719.83-2.656 1.015a4.182 4.182 0 0 0-7.126 3.814 11.874 11.874 0 0 1-8.62-4.37 4.168 4.168 0 0 0-.566 2.103c0 1.45.738 2.731 1.86 3.481a4.168 4.168 0 0 1-1.894-.523v.052a4.185 4.185 0 0 0 3.355 4.101 4.21 4.21 0 0 1-1.89.072A4.185 4.185 0 0 0 7.97 16.65a8.394 8.394 0 0 1-6.191 1.732 11.83 11.83 0 0 0 6.41 1.88c7.693 0 11.9-6.373 11.9-11.9 0-.18-.005-.362-.013-.54a8.496 8.496 0 0 0 2.087-2.165z" />
                      </svg>
                    </a>
                    <a href="https://github.com/tecsudo" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-[#00E2D6]/10 flex items-center justify-center text-[#00E2D6] hover:bg-[#00E2D6]/20 transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <a href="https://linkedin.com/company/tecsudo" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-[#00E2D6]/10 flex items-center justify-center text-[#00E2D6] hover:bg-[#00E2D6]/20 transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="lg:col-span-3 p-8 lg:p-12">
                <h3 className="text-2xl font-bold mb-2 text-white">Let&apos;s Build Something Amazing Together</h3>
