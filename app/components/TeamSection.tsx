...
export default function TeamSection() {
  const teamMembers = [
    ...
    },
    {
      name: 'Jane Smith',
      role: 'CTO',
      bio: 'Jane leads our technical team with expertise in cloud architecture and system design.',
      skills: ['Cloud Architecture', 'System Design', 'DevOps']
    },
    {
      name: 'Mike Johnson',
      role: 'Lead Developer',
      bio: 'Mike specializes in frontend development with React and Next.js.',
      skills: ['React', 'Next.js', 'TypeScript']
    },
    {
      name: 'Sarah Williams',
      role: 'UI/UX Designer',
      bio: 'Sarah creates beautiful, intuitive interfaces that users love.',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
          {teamMembers.map((member, index) => (
            <div key={index} className="card p-6">
              ...
              <p className="text-[#00E2D6] font-medium mb-3">{member.role}</p>
              ...
              <div className="flex space-x-3">
                <a href="#" className="text-gray-400 hover:text-[#00E2D6]">
